...
import (
	...
	"github.com/ikaiguang/protoc-gen-go/internal/genid"
	"github.com/ikaiguang/protoc-gen-go/internal/strs"
	"github.com/ikaiguang/protoc-gen-go/proto"
	"github.com/ikaiguang/protoc-gen-go/reflect/protodesc"
	...
	"github.com/ikaiguang/protoc-gen-go/types/pluginpb"
)
...
func (opts Options) New(req *pluginpb.CodeGeneratorRequest) (*Plugin, error) {
	...
	//
	//     option go_package = "github.com/ikaiguang/protoc-gen-go/types/known/anypb";
	//
...
// For example: "github.com/ikaiguang/protoc-gen-go/compiler/protogen"
