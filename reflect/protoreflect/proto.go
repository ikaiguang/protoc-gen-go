...
// The "github.com/ikaiguang/protoc-gen-go/reflect/protodesc" package converts between
...
// return the protobuf descriptor for the values.
//
// The "github.com/ikaiguang/protoc-gen-go/types/dynamicpb" package can be used to
